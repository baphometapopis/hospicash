      ...
      renderCell: (params) => (
        <p
          onClick={() =>
            ...
            navigate("/View_Endorsment_Details", {
              state: { selectedID: params.row },
            })
          }
          className="bg-primary text-white p-1 rounded cursor-pointer"
        >
          View
        </p>
  ...
  return (
    ...
    >
      ...
      <DataGrid
        ...
        rowCount={[]}
        columns={columns}
        getRowId={(row) => row.endorsement_id}
        rowsPerPageOptions={[]}
        getRowHeight={() => "auto"}
        sx={{
          border: "none",
...
export default EndorsmentPolicyTable;
